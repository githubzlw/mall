package com.macro.mall.shopify.cache;
...
public class RedisUtil {
    ...
    public static final String AUTH_GET_TOKEN = "busysell:authGetToken:";
    public static final String AUTH_URI = "busysell:authGetToken:";
    public static final String GET_ORDERS_BY_SHOPIFY_NAME = "busysell:getOrdersByShopifyName:";
    public static final String GET_COUNTRY_BY_SHOPIFY_NAME = "busysell:getCountryByShopifyName:";
