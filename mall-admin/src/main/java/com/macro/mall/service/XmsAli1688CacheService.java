...
public class XmsAli1688CacheService {
    ...
    public boolean deleteItemByKeyword(Integer page, String keyword, String start_price, String end_price,
                                       String sort) {
        String key = getRedisKeyInfo(page, keyword, start_price, end_price, sort);
