...
public class ProductUtils {
    ...
    public boolean insertShopifyToPms(XmsCustomerProduct customerProduct) {
        ...
        try {
            ...
            //添加产品表
            PmsProductParam productParam = new PmsProductParam();
            XmsSourcingList xmsSourcingList = this.getXmsSourcingListByCustom(customerProduct);
            //分类id
            productParam.setProductCategoryId(productCategoryList.get(0).getId());
            //属性分类id
    ...
    private XmsSourcingList getXmsSourcingListByCustom(XmsCustomerProduct customerProduct) {
        ...
        // https://busysell-official.myshopify.com/admin/products/6989854277827
        ...
        if (StrUtil.isNotBlank(customerProduct.getShopifyName()) && null != customerProduct.getShopifyProductId() && customerProduct.getShopifyProductId() > 0) {
            sourcingInfo.setUrl("https://" + customerProduct.getShopifyName() + ".myshopify.com/admin/products/" + customerProduct.getShopifyProductId());
        }
        return sourcingInfo;
    }
