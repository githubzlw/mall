package com.macro.mall.onebound.service.impl;
...
import com.macro.mall.onebound.config.OneBoundConfig;
import com.macro.mall.onebound.domain.AliExpressItem;
import com.macro.mall.onebound.domain.ItemDetails;
import com.macro.mall.onebound.domain.ItemResultPage;
import com.macro.mall.onebound.service.AliExpressCacheService;
import com.macro.mall.onebound.service.AliExpressService;
import com.macro.mall.onebound.util.DataDealUtil;
import com.macro.mall.onebound.util.InvalidKeyWord;
import com.macro.mall.onebound.util.InvalidPid;
...
public class AliExpressServiceImpl implements AliExpressService {
    ...
    @Autowired
    public AliExpressServiceImpl(StringRedisTemplate redisTemplate, AliExpressCacheService cacheService, OneBoundConfig config) {
