...
import com.macro.mall.onebound.domain.Ali1688Item;
import com.macro.mall.onebound.domain.ItemDetails;
import com.macro.mall.onebound.service.Ali1688CacheService;
import com.macro.mall.onebound.service.Ali1688Service;
...
public class Ali1688ServiceImpl implements Ali1688Service {
    ...
    @Autowired
    public Ali1688ServiceImpl(Ali1688CacheService ali1688CacheService, OneBoundConfig oneBoundConfig, StringRedisTemplate redisTemplate) {
